...
//1 acre = 0.00404686 sqkm / 4046.86 sqkm
var controlTemplate = _.template("<a class=\"<%= model.className %>-toggle js-toggle\" href=\"#\" title=\"Mesurar distancias y areas\">Mesurar</a>\n<div class=\"<%= model.className %>-interaction js-interaction\">\n  <div class=\"js-startprompt startprompt\">\n    <h3>Mesurar Distancias y Areas</h3>\n    <ul class=\"tasks\">\n      <a href=\"#\" class=\"js-start start\">Crear una nueva mesura</a>\n    </ul>\n  </div>\n  <div class=\"js-measuringprompt\">\n    <h3>Measure Distances and Areas</h3>\n    <p class=\"js-starthelp\">Empiece a mesurar añadiendo puntos al mapa</h3>\n    <div class=\"js-results results\"></div>\n    <ul class=\"js-measuretasks tasks\">\n      <li><a href=\"#\" class=\"js-cancel cancel\">Cancelar</a></li>\n      <li><a href=\"#\" class=\"js-finish finish\">Finalizar mesura</a></li>\n    </ul>\n  </div>\n</div>");
var resultsTemplate = _.template("<div class=\"group\">\n<p class=\"lastpoint heading\">Ultimo punto</p>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n</div>\n<% if (model.pointCount > 1) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Distancia</span> <%= humanize.numberFormat(model.length.feet, 0) %> Feet (<%= humanize.numberFormat(model.length.miles, 2) %> Miles)</p>\n</div>\n<% } %>\n<% if (model.pointCount > 2) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Area</span> <%= humanize.numberFormat(model.area.acres, 2) %> Acres222 <%= humanize.numberFormat(model.area.sqmeters, 2) %></p>\n</div>\n<% } %>");
var pointPopupTemplate = _.template("<h3>Localizacion de punto</h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrar</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Eliminar</a></li>\n</ul>");
var linePopupTemplate = _.template("<h3>Mesura de lineas</h3>\n<p><%= humanize.numberFormat(0.0003048*model.length.feet, 0) %> Kilometros</p>\n<p><%= humanize.numberFormat(1609.34*model.length.miles, 2) %> metros</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrar en esta linea</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Eliminar</a></li>\n</ul>");
var areaPopupTemplate = _.template("<h3>Area</h3>\n<p><%= humanize.numberFormat(0.00404686*model.area.acres, 2)   %> Km2 <%= humanize.numberFormat(model.area.acres, 2) %> Acres</p>\n<p><%= humanize.numberFormat(0.0003048*model.length.feet, 0) %> Kilometros de Perimetro</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrar en esta Area</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Eliminar</a></li>\n</ul>");
L.Control.Measure = L.Control.extend({
  _className: 'leaflet-control-measure',
  options: {
    position: 'topleft',
    activeColor: '#E51414',     // base color for map features while actively measuring
    completedColor: '#F97596',  // base color for permenant features generated from completed measure
