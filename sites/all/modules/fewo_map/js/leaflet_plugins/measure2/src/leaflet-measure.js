...
L.Control.Measure = L.Control.extend({
  ...
  options: {
    position: 'topleft',
    activeColor: '#FF495F',     // base color for map features while actively measuring
    completedColor: '#FF4B4B',  // base color for permenant features generated from completed measure
