...
L.Icon = L.Class.extend({
	...
	_setIconStyles: function (img, name) {
		var options = this.options,
		    ...
		    anchor;
	if (this.options._name) {
			console.log('name is '+this.options._name)
			img.setAttribute('name', this.options._name);
			}
		if (name === 'shadow') {
...
L.Marker = L.Class.extend({
	...
	_initIcon: function () {
		...
		if (options.keyboard) {
			...
			console.log('name is '+this.options._n_comun_tid)
		//this._path.setAttribute('name', this.options._name);

		L.DomUtil.addClass(icon, this.options._name);
		L.DomUtil.addClass(icon, this.options._n_comun_tid);
		L.DomUtil.addClass(icon, this.options._entity_id);
