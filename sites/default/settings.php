 ...
 *
 */
$drupal_hash_salt = 'NdR0KKwNrVqgrZzzbZeiEpki0hctCRONL8-PhGD1vZo';
...
$base_url = 'https://dopa.gis-ninja.eu';  // NO trailing slash!
 ...
 */
 ...
 ini_set('pcre.recursion_limit', 4000000);
...
# $conf['proxy_server'] = '10.168.209.73';
# $conf['proxy_port'] = 8012;
 #$conf['proxy_username'] = '';
 #$conf['proxy_password'] = '';
 #$conf['proxy_user_agent'] = '';
# $conf['proxy_exceptions'] = array('127.0.0.1', 'localhost','139.191.147.128','esp2.jrc.it', 'h05-dev-vm8.jrc.it', 'dopa-services.jrc.ec.europa.eu', 'h05-prod-vm11.jrc.it', 'lrm-maps.jrc.ec.europa.eu', 'h05-dev-vm100.jrc.it','139.191.147.141','h05-prd-vm19.jrc.it');
...
define('FPFIS_COMMON_LIBRARIES_PATH','/srv/www/htdocs/sites/all/modules/ecas/libraries');
define('FPFIS_SERVER_HOSTNAME','h05-dev-vm31.jrc.it');
/*
LDAP conf (questa parte serve solo per l’integrazione con LDAP, per la quale bisogna prima richiedere un utente dedicato)
*/
...
define('FPFIS_LDAP_USER_DN', 'uid=j53b039,ou=People,o=cec.eu.int');
define('FPFIS_LDAP_PASSWORD', 'BpDDOE5Zk');
define('FPFIS_LDAP_UID', 'uid');
define('FPFIS_LDAP_CN', 'cn');
define('FPFIS_LDAP_MAIL', 'mail');

/*
ECAS conf
*/
define('FPFIS_ECAS_PATH', FPFIS_COMMON_LIBRARIES_PATH . '/phpcas/CAS.php');
