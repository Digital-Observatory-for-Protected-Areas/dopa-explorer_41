...
$databases = array (
  'default' => array (
    'default' => array (
      ...
      'username' => 'h05espdru',
      'password' => 'Changeme',
      'host' => 'h05-srv-dbp96.jrc.it',
      'port' => '5432',
      'driver' => 'pgsql',
      'prefix' => '',
    ),
  ),
    'VT_postgres_africa' => array (
      'default' => array (
        'database' => 'africa_platform',
        'username' => 'postgres',
        'password' => '83uZZ878qM',
        'host' => 's-jrciprap251p.jrc.it',
        'port' => '5432',
        'driver' => 'pgsql',
        'prefix' => '',
      ),
 ...
 *
 */
$drupal_hash_salt = '080E7LWzNJYOZk0xTWf7l_pYXCKlafXrbkZ0GfOTFCc';
...
# $conf['proxy_server'] = '10.168.209.73';
 ...
 #$conf['proxy_password'] = '';
 #$conf['proxy_user_agent'] = '';
 $conf['proxy_exceptions'] = array('127.0.0.1', 'localhost','139.191.147.128','esp2.jrc.it', 'dopa-services.jrc.ec.europa.eu', 'h05-prod-vm11.jrc.it', 'lrm-maps.jrc.ec.europa.eu', 'h05-dev-vm100.jrc.it','139.191.147.141');
/**
